...
public class Login_ManagerController implements Initializable {
    ...
    public Login_ManagerController() {
    ...
    private void Push_BTN_Login(ActionEvent event) {
        ...
        String sql = "SELECT * FROM manager WHERE id = ? and password = ?"; // sql문 하드코딩
        ...
        try {
            ...
            if (!resultSet.next()) {
                ...
                Parent window1;
                window1 = FXMLLoader.load(getClass().getResource("/storemanagement/SelectFunction.fxml"));
